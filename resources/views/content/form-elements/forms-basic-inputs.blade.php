...
<div class="row g-6">
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body demo-vertical-spacing demo-only-element">
                ...
                <div class="form-floating form-floating-outline mb-6">
                    <select multiple="multiple" class="form-select h-100" id="exampleFormControlSelect2" aria-label="Multiple select example">
                        <option selected="selected">Open this select menu</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
                        <option value="3">Three</option>
                ...
                <div class="form-floating form-floating-outline mb-6">
                    <input class="form-control" type="text" id="exampleFormControlReadOnlyInput1" placeholder="Readonly input here..." readonly="readonly" />
                    <label for="exampleFormControlReadOnlyInput1">Read only without value</label>
                </div>
                <div class="form-floating form-floating-outline">
                    <input type="text" readonly="readonly" class="form-control-plaintext px-0" id="exampleFormControlReadOnlyInputPlain1" value="email@example.com" />
                    <label for="exampleFormControlReadOnlyInputPlain1" class="px-0">Read only with value</label>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row row-bordered g-0">
                <div class="col-md p-6">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="defaultCheck2" checked="checked" />
                        <label class="form-check-label" for="defaultCheck2"> Indeterminate </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="defaultCheck3" checked="checked" />
                        <label class="form-check-label" for="defaultCheck3"> Checked </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="disabledCheck1" disabled="disabled" />
                        <label class="form-check-label" for="disabledCheck1"> Disabled Unchecked </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="disabledCheck2" disabled="disabled" checked="checked" />
                ...
                <div class="col-md p-6">
                    ...
                    <div class="form-check">
                        <input name="default-radio-1" class="form-check-input" type="radio" value="" id="defaultRadio2" checked="checked" />
                        <label class="form-check-label" for="defaultRadio2"> Checked </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" value="" id="disabledRadio1" disabled="disabled" />
                        <label class="form-check-label" for="disabledRadio1"> Disabled unchecked </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" value="" id="disabledRadio2" disabled="disabled" checked="checked" />
            ...
            <div class="row row-bordered g-0">
                <div class="col-xxl-6 col-xl-12 col-md-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check form-switch mb-2">
                            <input class="form-check-input" type="checkbox" id="flexSwitchCheckDisabled" disabled="disabled" />
                ...
                <div class="col-xxl-6 col-xl-12 col-md-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check form-check-reverse">
                            <input class="form-check-input" type="checkbox" value="" id="reverseCheck2" disabled="disabled" />
                        ...
                        <div class="form-check form-check-reverse">
                            <input name="reverse-radio-1" class="form-check-input" type="radio" value="" id="reverseRadio2" checked="checked" />
        ...
        <div class="card mb-6 mb-xl-0">
            ...
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <input type="range" class="form-range" id="disabledRange" disabled="disabled" />
                </div>
                <div class="mb-4">
    ...
    <div class="col-xl-6">
        ...
        <div class="card mb-6">
            ...
            <div class="card-body">
                <div class="form-floating form-floating-outline mb-6">
          <input class="form-control" type="text" placeholder="{{ config('variables.templateName') }}"
            id="html5-text-input" />
                ...
                <div class="form-floating form-floating-outline mb-6">
          <input class="form-control" type="url" placeholder="{{ config('variables.creatorUrl') }}"
            id="html5-url-input" />
                ...
                <div class="form-floating form-floating-outline mb-6">
                    <input class="form-control" type="color" id="html5-color-input" value="#8c57ff" title="Choose your color" />
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <input class="form-control" type="file" id="formFileMultiple" multiple="multiple" />
                </div>
                <div class="mb-4">
                    <label for="formFileDisabled" class="form-label">Disabled file input example</label>
                    <input class="form-control" type="file" id="formFileDisabled" disabled="disabled" />
                </div>
                <div class="mb-4">
