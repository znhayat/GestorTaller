            ...
            <div class="card-body">
                <div class="divider text-start">
                    <div class="divider-text">
                        <i class="icon-base ri ri-sun-fill"></i>
                    </div>
                </div>
                <div class="divider text-start-center">
                    <div class="divider-text">
                        <i class="icon-base ri ri-vip-crown-line"></i>
                    </div>
                </div>
                <div class="divider">
                    <div class="divider-text">
                ...
                <div class="divider text-end-center">
                    <div class="divider-text">
                        <i class="icon-base ri ri-goblet-fill"></i>
                    </div>
                </div>
                <div class="divider text-end">
                    <div class="divider-text">
                        <i class="icon-base ri ri-scissors-line rotate-180"></i>
                    </div>
                </div>
            </div>
        </div>
