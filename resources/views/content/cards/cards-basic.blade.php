    ...
    <div class="col-md-6 col-lg-4">
        <div class="card h-100">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <h6 class="card-subtitle">Support card subtitle</h6>
                <img class="img-fluid d-flex mx-auto my-4 rounded" src="{{ asset('assets/img/elements/4.png') }}" alt="Card image cap" />
                <p class="card-text">Bear claw sesame snaps gummies chocolate.</p>
                <a href="javascript:void(0);" class="card-link">Card link</a>
                <a href="javascript:void(0);" class="card-link">Another link</a>
            </div>
...
<div class="row g-6" data-masonry='{"percentPosition": true }'>
    ...
    <div class="col-sm-6 col-lg-4">
        <div class="card">
            <img class="card-img-top card-img-bottom" src="{{ asset('assets/img/elements/4.png') }}" alt="Card image cap" />
        </div>
    </div>
    <div class="col-sm-6 col-lg-4">
