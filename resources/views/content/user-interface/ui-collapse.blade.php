...
<div class="row g-6">
    ...
    <div class="col-12">
        <div class="card">
          ...
          <a href="{{ config('variables.documentation') }}/ui-collapse.html#horizontal-collapse"
            target="_blank">documentation</a>.
                ...
                <div style="min-height: 120px;">
                    <div class="collapse-horizontal collapse show" id="collapseWidthExample">
                        <div class="p-4 border rounded" style="width: 300px;">Lorem Ipsum is simply dummy text of the printing and typesetting industry Ipsum has been the.</div>
                    </div>
                </div>
            </div>
        </div>
