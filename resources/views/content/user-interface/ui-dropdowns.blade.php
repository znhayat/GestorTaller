    ...
    <div class="card-body">
      <div class="row gy-3">
        ...
        <div class="col-lg-3 col-sm-6 col-12">
          ...
          <div class="demo-inline-spacing">
            <div class="btn-group" id="dropdown-icon-demo">
              <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="icon-base ri ri-menu-line me-1"></i> With Icon</button>
              <ul class="dropdown-menu">
                <li>
                  <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i class="icon-base ri ri-arrow-right-s-line scaleX-n1-rtl"></i>Action</a>
                </li>
                <li>
                  <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i class="icon-base ri ri-arrow-right-s-line scaleX-n1-rtl"></i>Another action</a>
                </li>
                <li>
                  <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i class="icon-base ri ri-arrow-right-s-line scaleX-n1-rtl"></i>Something else here</a>
                </li>
                <li>
                  <hr class="dropdown-divider" />
                </li>
                <li>
                  <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i class="icon-base ri ri-arrow-right-s-line scaleX-n1-rtl"></i>Separated link</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
          ...
          <div class="demo-inline-spacing">
            <div class="btn-group">
              <button type="button" class="btn btn-primary btn-icon rounded-pill dropdown-toggle hide-arrow" data-bs-toggle="dropdown" aria-expanded="false"><i class="icon-base ri ri-more-2-line"></i></button>
