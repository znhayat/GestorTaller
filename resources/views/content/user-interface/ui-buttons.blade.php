        ...
        <div class="card">
            ...
            <div class="row row-bordered g-0">
                <div class="col-lg-4 p-6">
                    ...
                    <div class="demo-inline-spacing">
                        <button type="button" class="btn btn-primary"><span class="icon-base ri ri-checkbox-circle-line icon-16px me-1_5"></span>Primary</button>
                        <button type="button" class="btn btn-secondary"><span class="icon-base ri ri-notification-4-line icon-16px me-1_5"></span>Secondary</button>
                    </div>
                    <div class="demo-inline-spacing">
                        <button type="button" class="btn rounded-pill btn-primary"><span class="icon-base ri ri-checkbox-circle-line icon-16px me-1_5"></span>Primary</button>
                        <button type="button" class="btn rounded-pill btn-secondary"><span class="icon-base ri ri-notification-4-line icon-16px me-1_5"></span>Secondary</button>
                    </div>
                </div>
                <div class="col-lg-4 p-6">
                    <small class="fw-medium">Outline</small>
                    <div class="demo-inline-spacing">
                        <button type="button" class="btn btn-outline-primary"><span class="icon-base ri ri-checkbox-circle-line icon-16px me-1_5"></span>Primary</button>
                        <button type="button" class="btn btn-outline-secondary"><span class="icon-base ri ri-notification-4-line icon-16px me-1_5"></span>Secondary</button>
                    </div>
                    <div class="demo-inline-spacing">
                        <button type="button" class="btn rounded-pill btn-outline-primary"><span class="icon-base ri ri-checkbox-circle-line icon-16px me-1_5"></span>Primary</button>
                        <button type="button" class="btn rounded-pill btn-outline-secondary"><span class="icon-base ri ri-notification-4-line icon-16px me-1_5"></span>Secondary</button>
                    </div>
                </div>
            </div>
            <hr class="m-0" />
                ...
                <div class="col-lg-4 p-6">
                    ...
                    <div class="demo-inline-spacing">
                        <button type="button" class="btn btn-icon btn-primary">
                            <span class="icon-base ri ri-check-double-line icon-22px"></span>
                        </button>
            ...
            <div class="row row-bordered g-0">
                <div class="col-xl-3 p-6">
                    ...
                    <div class="demo-vertical-spacing">
                        ...
                        <button type="button" class="btn btn-primary d-block" disabled="disabled" data-bs-toggle="button">Disabled toggle button</button>
                    </div>
                </div>
                <div class="col-xl-3 p-6">
                    ...
                    <div class="demo-vertical-spacing">
                        ...
                        <div class="d-block">
                            <input type="checkbox" class="btn-check" id="btn-check-2" checked="checked" />
                            <label class="btn btn-primary" for="btn-check-2">Checked</label>
                        </div>
                        <div class="d-block">
                            <input type="checkbox" class="btn-check" id="btn-check-3" checked="checked" />
                ...
                <div class="col-xl-6 p-6">
                    ...
                    <div class="demo-vertical-spacing">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                            <input type="checkbox" class="btn-check" id="btncheck1" checked="checked" />
                            <label class="btn btn-outline-primary" for="btncheck1">
                                <span class="d-block d-sm-none">
                                    <i class="icon-base ri ri-home-4-line icon-20px"></i>
                                </span>
                            ...
                            <label class="btn btn-outline-primary" for="btncheck2">
                                <span class="d-block d-sm-none">
                                    <i class="icon-base ri ri-flight-takeoff-line icon-20px"></i>
                                </span>
                            ...
                            <label class="btn btn-outline-primary" for="btncheck3">
                                <span class="d-block d-sm-none">
                                    <i class="icon-base ri ri-notification-4-line icon-20px"></i>
                                </span>
                        ...
                        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                            <input type="radio" class="btn-check" name="btnradio" id="btnradio1" checked="checked" />
                        ...
                        <div class="btn-toolbar demo-inline-spacing gap-2" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group" role="group" aria-label="First group">
                                <button type="button" class="btn btn-outline-secondary">
                                    <i class="icon-base ri ri-notification-4-line"></i>
                                </button>
                                <button type="button" class="btn btn-outline-secondary">
                                ...
                                <button type="button" class="btn btn-outline-secondary">
                                    <i class="icon-base ri ri-message-2-line"></i>
                                </button>
                            </div>
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="mt-4">
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                ...
                                <button type="button" class="btn btn-outline-secondary">
                                    <i class="icon-base ri ri-rocket-2-line"></i>
                                </button>
                                <button type="button" class="btn btn-outline-secondary">
                                    <i class="icon-base ri ri-lightbulb-line"></i>
                                </button>
                                <div class="btn-group" role="group">
                                    <button id="btnGroupDrop1" type="button" class="btn btn-outline-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <span class="d-none d-sm-block">Dropdown</span>
                                    </button>
