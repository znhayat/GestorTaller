...
@section('content')
  ...
  <div class="bs-toast toast toast-placement-ex m-2" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="2000">
    <div class="toast-header">
      <i class="icon-base ri ri-home-4-fill icon-sm me-2"></i>
    ...
    <div class="row g-0">
      <div class="col-md-6 p-6">
        ...
        <div class="toast-container position-relative">
          ...
          <div class="bs-toast toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
              <i class="icon-base ri ri-bootstrap-fill icon-sm text-primary me-2"></i>
              <div class="me-auto fw-medium">Bootstrap</div>
              <small class="text-body-secondary">11 mins ago</small>
              <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
          ...
          <div class="bs-toast toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
              <i class="icon-base ri ri-spam-fill icon-sm text-secondary me-2"></i>
              <div class="me-auto fw-medium">Bootstrap</div>
              <small class="text-body-secondary">11 mins ago</small>
              <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
          ...
          <div class="bs-toast toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
              <i class="icon-base ri ri-checkbox-circle-fill icon-sm text-success me-2"></i>
              <div class="me-auto fw-medium">Bootstrap</div>
              <small class="text-body-secondary">11 mins ago</small>
              <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
          ...
          <div class="bs-toast toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
              <i class="icon-base ri ri-error-warning-fill icon-sm text-danger me-2"></i>
              <div class="me-auto fw-medium">Bootstrap</div>
              <small class="text-body-secondary">11 mins ago</small>
              <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
          ...
          <div class="bs-toast toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
              <i class="icon-base ri ri-alert-fill icon-sm text-warning me-2"></i>
              <div class="me-auto fw-medium">Bootstrap</div>
              <small class="text-body-secondary">11 mins ago</small>
              <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
          ...
          <div class="bs-toast toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
              <i class="icon-base ri ri-information-fill icon-sm text-info me-2"></i>
              <div class="me-auto fw-medium">Bootstrap</div>
              <small class="text-body-secondary">11 mins ago</small>
              <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
          ...
          <div class="bs-toast toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
              <i class="icon-base ri ri-contrast-fill icon-sm text-dark me-2"></i>
              <div class="me-auto fw-medium">Bootstrap</div>
              <small class="text-body-secondary">11 mins ago</small>
              <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
      ...
      <div class="col-md-6 ui-bg-overlay-container p-6">
        ...
        <div class="small fw-medium mb-4 text-white">Translucent</div>
