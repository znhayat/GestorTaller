    ...
    <div class="col-md-12">
        <div class="nav-align-top">
            <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-2 gap-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="javascript:void(0);"><i class="icon-base ri ri-link-m icon-sm me-1_5"></i> Connections</a>
                </li>
            </ul>
        </div>
        <div class="card">
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="card-header">
                        ...
                        <p class="mb-1 card-subtitle mt-0">Display content from your connected accounts on your site</p>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="d-flex mb-4 align-items-center">
                            ...
                            <div class="flex-grow-1 row align-items-center">
                                ...
                                <div class="col-5 text-end">
                                    <button class="btn btn-outline-secondary btn-icon"><i class="icon-base ri ri-link icon-22px"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets/img/icons/brands/twitter-light.png') }}" alt="twitter" class="me-4" height="32" />
                            </div>
                            <div class="flex-grow-1 row align-items-center">
                                <div class="col-7">
                                ...
                                <div class="col-5 text-end">
                                    <button class="btn btn-outline-danger btn-icon"><i class="icon-base ri ri-delete-bin-line icon-22px"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex mb-4 align-items-center">
