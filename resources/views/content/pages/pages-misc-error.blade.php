...
<div class="misc-wrapper">
    ...
    <div class="d-flex justify-content-center mt-5">
        ...
        <img src="{{ asset('assets/img/illustrations/misc-mask-light.png') }}" alt="misc-error" class="scaleX-n1-rtl misc-bg d-none d-lg-inline-block z-n1" height="172" />
        <div class="d-flex flex-column align-items-center">
            <img src="{{ asset('assets/img/illustrations/404.png') }}" alt="misc-error" class="misc-model img-fluid z-1" width="780" />
            <div>
                <a href="{{ url('/') }}" class="btn btn-primary text-center mb-6">Back to home</a>
            </div>
        </div>
    </div>
</div>
