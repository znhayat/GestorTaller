    ...
    <div class="col-md-12">
        <div class="nav-align-top">
            <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-2 gap-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="javascript:void(0);"><i class="icon-base ri ri-notification-4-line icon-sm me-1_5"></i> Notifications</a>
                </li>
                <li class="nav-item">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <span class="card-subtitle">We need permission from your browser to show notifications. <a href="javascript:void(0);" class="notificationRequest">Request Permission</a></span>
                <div class="error"></div>
            </div>
