...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        Route::resource('fotos', FotoController::class)->only(['edit', 'update', 'destroy']);
  ...
  Route::get('/manual', [ManualController::class, 'index'])->name('manual.index');
    ...
    Route::resource('fotos', FotoController::class)->only(['index', 'show', 'create', 'store']);
    Route::get('/facturas/{id}/imprimir', [FacturaController::class, 'imprimir'])->name('facturas.imprimir');
    Route::patch('/facturas/{id}/pagar', [FacturaController::class, 'marcarPagado'])->name('facturas.marcarPagado');
